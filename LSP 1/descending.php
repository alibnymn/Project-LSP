...
<body>
    ...
    <div class="container">
        ...
        <div class="container-fluid">
            ...
            <div class="py-2">
                <!-- Tabel -->
                <h1 align="center">Pengurutan Data Secara descending</h1>
          ...
          karena memakai data table maka akan ada fungsi lain seperti search,pagination, dan batas data</p> -->
                <table class="table table-bordered bg-body">
                    ...
                    <tbody>
                        <?php
                //cara masukan file txt atau mengkoneksikan dan kemudian di tampilakn pada tabel tetapi secara ascending
